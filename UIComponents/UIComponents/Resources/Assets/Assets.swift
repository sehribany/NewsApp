...
public enum Asset {
  ...
  public enum Icons {
    ...
    public static let icCategories = ImageAsset(name: "ic_categories")
    public static let icHome = ImageAsset(name: "ic_home")
    public static let icSearch = ImageAsset(name: "ic_search")
  }
  public enum Images {
    public static let imgIntro1 = ImageAsset(name: "img_intro1")
    public static let imgIntro2 = ImageAsset(name: "img_intro2")
    public static let imgIntro3 = ImageAsset(name: "img_intro3")
